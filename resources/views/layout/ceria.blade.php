...
<body>
    ...
    <div class="col-sm-10">
    <header>
        <img src="{{asset('foto1.jpeg')}}" class="img-responsive" style="width:10%;" alt="foto">
        <h1 style="font-size:20px">Muhammad 'Adlillah Aqsha Hibatul Haqqi</h1>
        <p>5026201001</p>
    </header>
    <hr>
...
<hr>
<footer>
    Made by Aqsha Haqqi - 5026201001
</footer>
    </div>
        </div>
        <br>
